...
A MERN stack project that helps farmers monitor soil data and automate irrigation.

### 🍱 Waste Food Management System
A platform connecting food donors with receivers to reduce food waste.
